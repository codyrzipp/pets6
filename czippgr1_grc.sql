...
CREATE TABLE `Guestbook` (
  `guest_id` mediumint(8) UNSIGNED NOT NULL,
  ...
  `mail_list` varchar(10) NOT NULL,
  `mail_format` varchar(10) DEFAULT NULL,
  `how_we_met` varchar(10) NOT NULL,
...
INSERT INTO `Guestbook` (`guest_id`, `first_name`, `last_name`, `title`, `company`, `email`, `comments`, `mail_list`, `mail_format`, `how_we_met`, `other`, `linkedin`, `timefilled`) VALUES
(2, 'Cody', 'Zipp', 'Co-Founder', 'SSE', 'codyrzipp@comcast.net', 'Love the site!', 'yes', 'html', 'Meetup', 'null', 'www.linkedin.com/in/codyr', '2019-11-25 22:39:20'),
(3, 'c', 'zipp', 'boss', 'man', 'cody@mail.com', 'yes', 'Array', 'HTML', '', '', 'www.linkedin/in/codyr', '2019-11-26 13:19:14'),
(4, 'c', 'zipp', 'boss', 'man', 'cody@mail.com', 'yes', 'Array', 'HTML', '', '', 'www.linkedin/in/codyr', '2019-11-26 13:20:40'),
(5, 'c', 'zipp', 'boss', 'man', 'cody@mail.com', 'yes', 'Array', 'HTML', '', '', 'www.linkedin/in/codyr', '2019-11-26 13:53:13'),
(6, 'c', 'zipp', 'dkfjlsd', 'lksndga', 'sdlkfands@mail.com', 'lsjdklfna', 'Array', 'Text', '', '', 'www.linkedin/in/codyr', '2019-11-26 15:04:31'),
(7, 'c', 'zipp', 'dkfjlsd', 'lksndga', 'sdlkfands@mail.com', 'lsjdklfna', 'Array', 'Text', '', '', 'www.linkedin/in/codyr', '2019-11-27 14:18:51'),
(8, 'c', 'z', '', '', 'c@mial.co', '', 'Array', '', '', '', 'www.linkedin/in/codyr', '2019-11-27 14:32:29'),
(9, 'c', 'z', '', '', 'c@mial.co', '', 'Array', '', '', '', 'www.linkedin/in/codyr', '2019-11-27 14:34:10'),
(10, 'Cody', 'Zipp', 'undefined', 'undefined', 'zippcody@gmail.com', 'undefined', 'yes', 'undefined', 'meetup', 'undefined', 'www.linkedin/in/codyr', '2019-12-01 14:40:26'),
(11, 'Cody', 'Zipp', 'CEO', 'Spaz Squad', 'codyzipp@sse.com', 'yessir I like this site', 'yes', 'HTML', 'haventMet', 'undefined', 'www.linkedin/in/codyr', '2019-12-01 15:50:51'),
(12, 'Cody', 'Zipp', 'CEO', 'Spaz Squad', 'codyzipp@sse.com', 'yessir I like this site', 'yes', 'HTML', 'haventMet', 'undefined', 'www.linkedin/in/codyr', '2019-12-01 15:51:16');
...
('12345665498', 'tomany', 'one', '1970-01-01', 3, 1),
('12345678910', 'ajd', 'sldk', '0000-00-00', 2, 0),
('12345679810', 'bill', 'bob', '0101-10-10', 2, 3),
('12345679811', 'bill', 'bob', '0101-10-10', 2, 3),
...
('45213658975', 'dlkfjs', 'dslkjfs', '0000-00-00', 0, 0),
...
--
ALTER TABLE `Guestbook`
  MODIFY `guest_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
